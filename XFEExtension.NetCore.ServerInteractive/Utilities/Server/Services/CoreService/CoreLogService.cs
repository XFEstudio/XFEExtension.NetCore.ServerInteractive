...
public partial class CoreLogService : ServerCoreUserServiceBase
{
    ...
    public async Task GetLog()
    {
        ...
        UserHelper.ValidatePermission(Json?["session"], Json?["deviceInfo"], ReturnArgs.ClientIP, GetPermission, GetEncryptedUserLoginModelFunction(), GetUserFunction(), ReturnArgs);
    ...
    public void ClearLog()
    {
        ...
        UserHelper.ValidatePermission(Json?["session"], Json?["deviceInfo"], ReturnArgs.ClientIP, ClearPermission, GetEncryptedUserLoginModelFunction(), GetUserFunction(), ReturnArgs);
